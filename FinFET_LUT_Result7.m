...
staticmux2=[ 8.3713  3.4140*1e3   28.5794    2.4983*1e3       88         0];
staticmux3=[ 17.0419 10.6017*1e3  180.6727   10.4448*1e3      54         1];
staticmux4=[ 20.3178 18.6290*1e3  378.4996   10.1941*1e3      110         3];
staticmux5=[ 25.6833 37.5297*1e3  963.8862   20.6020*1e3      230         7];
staticmux6=[ 25.9005 74.9174*1e3  1940.4     41.1093*1e3      462         12];
...
y=[ddr2(4) ddr2_spcsa(4) ddr2_sd(4) ddr2_sd_spcsa(4) staticmux2(1); 
   ddr3(4) ddr3_spcsa(4) ddr3_sd(4) ddr3_sd_spcsa(4) staticmux3(1);
   ddr4(4) ddr4_spcsa(4) ddr4_sd(4) ddr4_sd_spcsa(4) staticmux4(1);
   ddr5(4) ddr5_spcsa(4) ddr5_sd(4) ddr5_sd_spcsa(4) staticmux5(1);
   ddr6(4) ddr6_spcsa(4) ddr6_sd(4) ddr6_sd_spcsa(4) staticmux6(1);];
...
legend('DDR','DDR+SPCSA','Separated Decoder DDR','Separated Decoder DDR+SPCSA', 'Complementary');
...
y=[ddr2(5) ddr2_spcsa(5) ddr2_sd(5) ddr2_sd_spcsa(5) staticmux2(2); 
   ddr3(5) ddr3_spcsa(5) ddr3_sd(5) ddr3_sd_spcsa(5) staticmux3(2);
   ddr4(5) ddr4_spcsa(5) ddr4_sd(5) ddr4_sd_spcsa(5) staticmux4(2);
   ddr5(5) ddr5_spcsa(5) ddr5_sd(5) ddr5_sd_spcsa(5) staticmux5(2);
   ddr6(5) ddr6_spcsa(5) ddr6_sd(5) ddr6_sd_spcsa(5) staticmux6(2);];
...
y=[ddr2(6) ddr2_spcsa(6) ddr2_sd(6) ddr2_sd_spcsa(6)  staticmux2(3); 
   ddr3(6) ddr3_spcsa(6) ddr3_sd(6) ddr3_sd_spcsa(6)  staticmux3(3);
   ddr4(6) ddr4_spcsa(6) ddr4_sd(6) ddr4_sd_spcsa(6)  staticmux4(3);
   ddr5(6) ddr5_spcsa(6) ddr5_sd(6) ddr5_sd_spcsa(6)  staticmux5(3);
   ddr6(6) ddr6_spcsa(6) ddr6_sd(6) ddr6_sd_spcsa(6)  staticmux6(3);];
...
y=[ddr2(7) ddr2_spcsa(7) ddr2_sd(7) ddr2_sd_spcsa(7) staticmux2(4); 
   ddr3(7) ddr3_spcsa(7) ddr3_sd(7) ddr3_sd_spcsa(7) staticmux3(4);
   ddr4(7) ddr4_spcsa(7) ddr4_sd(7) ddr4_sd_spcsa(7) staticmux4(4);
   ddr5(7) ddr5_spcsa(7) ddr5_sd(7) ddr5_sd_spcsa(7) staticmux5(4);
   ddr6(7) ddr6_spcsa(7) ddr6_sd(7) ddr6_sd_spcsa(7) staticmux6(4);];
...
y=[ddr2(8) ddr2_spcsa(8) ddr2_sd(8) ddr2_sd_spcsa(8) staticmux2(5); 
   ddr3(8) ddr3_spcsa(8) ddr3_sd(8) ddr3_sd_spcsa(8) staticmux3(5);
   ddr4(8) ddr4_spcsa(8) ddr4_sd(8) ddr4_sd_spcsa(8) staticmux4(5);
   ddr5(8) ddr5_spcsa(8) ddr5_sd(8) ddr5_sd_spcsa(8) staticmux5(5);
   ddr6(8) ddr6_spcsa(8) ddr6_sd(8) ddr6_sd_spcsa(8) staticmux6(5);];
...
y=[ddr2(9) ddr2_spcsa(9) ddr2_sd(9) ddr2_sd_spcsa(9) staticmux2(6); 
   ddr3(9) ddr3_spcsa(9) ddr3_sd(9) ddr3_sd_spcsa(9) staticmux3(6);
   ddr4(9) ddr4_spcsa(9) ddr4_sd(9) ddr4_sd_spcsa(9) staticmux4(6);
   ddr5(9) ddr5_spcsa(9) ddr5_sd(9) ddr5_sd_spcsa(9) staticmux5(6);
   ddr6(9) ddr6_spcsa(9) ddr6_sd(9) ddr6_sd_spcsa(9) staticmux6(6);];
